...
const model_lower = process.env.MODEL || '{{cookiecutter.model}}';
const model = model_lower.charAt(0).toUpperCase() + model_lower.slice(1);

const TABLE_NAME = model;
const TABLE_PK = model_lower + 'Id';
const TABLE_SK = 'createdAt';

export class {{cookiecutter.model_class_name}}Stack extends cdk.Stack {
